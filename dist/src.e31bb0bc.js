...
},{}],"KeyManager.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(KeyManager, [{
    ...
    key: "pushToLastWord",
    value: function pushToLastWord(key) {
...
var _default = {
  data: function data() {
    return {
      message: '',
      keyManager: new _KeyManager.KeyManager()
    };
  },
  mounted: function mounted() {
    var _this = this;
    ...
    document.addEventListener('keydown', function (e) {
      _this.keyManager.handleKeyDown(e.key);

      _this.message = String(_this.keyManager.words);
    });
  }
};
exports.default = _default;
        var $b5b562 = exports.default || module.exports;
      
      if (typeof $b5b562 === 'function') {
        $b5b562 = $b5b562.options;
      }
    
        /* template */
        Object.assign($b5b562, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b5b562', $b5b562);
          } else {
            api.reload('$b5b562', $b5b562);
          }
        }
...
},{"./KeyManager":"KeyManager.js","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
